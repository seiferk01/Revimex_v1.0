...
class LineasInfoController: UIViewController {
    ...
    func inversionista(){
        ...
        let tapGestureRecognizer = UITapGestureRecognizer(target: self, action: #selector(inversionistaTaped(tapGestureRecognizer:)))
        botonComenzar.addGestureRecognizer(tapGestureRecognizer)
    }
    ...
    @objc func inversionistaTaped(tapGestureRecognizer: UITapGestureRecognizer) {
        performSegue(withIdentifier: "lineasToInversionista", sender: nil)
    }
